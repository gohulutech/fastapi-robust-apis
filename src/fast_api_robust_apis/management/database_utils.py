...
# Import from app
from fast_api_robust_apis.db.session import engine, SessionLocal, Base
from fast_api_robust_apis.db import init_db
...
def create_sample_data(force_recreate=False):
    ...
    try:
        ...
        location2 = location_repository.create(
            db=db, name="Downtown Store", address="456 Main St, Downtown", capacity=200
        )
